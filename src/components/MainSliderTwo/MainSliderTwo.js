...
const MainSliderTwo = (props) => {

  const {tourLocations, tour, userFavouritesTourIds} = props;
      ...
      <Swiper className="thm-swiper__slider" {...mainSlideOptions}>
        <div className="swiper-wrapper">
          {tourLocations.map((tourLocation) => (
            <SingleSlide key={tourLocation.id} tour={tour} image={tourLocation.image} userFavouritesTourIds={userFavouritesTourIds}  />
          ))}
        </div>
